...
/**
 * @ORM\Entity(repositoryClass=Form5Trimestre1Repository::class)
 */
class Form5Trimestre1
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToOne(targetEntity=DateAnneePourForm::class, mappedBy="annee", cascade={"persist", "remove"})
     */
    private $annee;

    /**
     * @ORM\ManyToOne(targetEntity=Date::class, inversedBy="form5")
     */
    private $date;
    ...
    public function getAnnee(): ?DateAnneePourForm
    {
        return $this->annee;
    }

    public function setAnnee(?DateAnneePourForm $annee): self
    {
        // unset the owning side of the relation if necessary
        if ($annee === null && $this->annee !== null) {
            $this->annee->setAnnee(null);
        }

        // set the owning side of the relation if necessary
        if ($annee !== null && $annee->getAnnee() !== $this) {
            $annee->setAnnee($this);
        }
