...
/**
 * @ORM\Entity(repositoryClass=Form5Trimestre4Repository::class)
 */
class Form5Trimestre4
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToOne(targetEntity=DateAnneePourForm::class, cascade={"persist", "remove"})
     */
    private $annee;

    /**
     * @ORM\ManyToOne(targetEntity=Date::class, inversedBy="form5Trimestre4s")
     */
    private $date;
